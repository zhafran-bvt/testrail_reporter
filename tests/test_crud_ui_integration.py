...
class TestCRUDUIFlows(BaseAPITestCase):
    ...
    def test_edit_plan_updates_entity(self):
        ...
        plan_id = 123
        payload = {"name": "Updated Plan Name", "description": "Updated description", "milestone_id": 5}
    ...
    def test_edit_run_updates_entity(self):
        ...
        run_id = 456
        payload = {"name": "Updated Run Name", "description": "Updated description", "refs": "REF-123"}
