...
class TestMemoryEfficiency:
    ...
    def test_streaming_response_simulation(self):
        ...
        assert memory_growth < reasonable_peak / 2, f"Final memory growth {memory_growth} bytes should be minimal with streaming"
    ...
    def test_concurrent_request_memory_isolation(self, num_concurrent_requests, data_size_per_request):
        ...
        assert memory_growth < expected_max_growth, f"Memory growth {memory_growth} bytes seems excessive for {num_concurrent_requests} concurrent requests"
    ...
    def test_large_response_chunking_simulation(self):
        ...
        assert memory_growth_during < reasonable_chunk_memory, f"Memory during processing {memory_growth_during} should be bounded by chunk size"
        assert final_memory_growth < reasonable_chunk_memory / 2, f"Final memory growth {final_memory_growth} should be minimal"
