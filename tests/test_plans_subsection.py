...
class TestPlansSubsection(BaseAPITestCase):
    ...
    def test_renderPlansSubsection_function_exists(self):
        ...
        self.assertIn("renderPlansSubsection", js, "renderPlansSubsection function should exist in compiled JS")
    ...
    def test_filterPlans_function_exists(self):
        ...
        self.assertIn("filterPlans", js, "filterPlans function should exist in compiled JS")
