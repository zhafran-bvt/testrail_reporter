...
class TestCacheEfficiency:
    ...
    @given(maxsize=st.integers(min_value=2, max_value=10), num_items=st.integers(min_value=1, max_value=20))
    ...
    @given(custom_ttl=st.integers(min_value=1, max_value=100))
    ...
    @given(num_operations=st.integers(min_value=10, max_value=50))
