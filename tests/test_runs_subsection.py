...
class TestRunsSubsection(unittest.TestCase):
    ...
    def test_renderRunsSubsection_function_exists(self):
        ...
        self.assertIn('renderRunsSubsection', js, 
                     "renderRunsSubsection function should exist in compiled JS")
    ...
    def test_populatePlanFilter_function_exists(self):
        ...
        self.assertIn('populatePlanFilter', js, 
                     "populatePlanFilter function should exist in compiled JS")
