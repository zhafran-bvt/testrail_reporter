...
class TestDeleteConfirmationDialog(BaseAPITestCase):
    ...
    def test_delete_modal_has_warning_icon(self):
        ...
        assert (
            "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10" in html or "M1 21h22L12 2" in html
    ...
    def test_delete_modal_entity_info_card_styling(self):
        ...
        assert (
            "rgba(239, 68, 68, 0.12)" in html or "rgba(239, 68, 68, 0.1)" in html
        ), "Entity info card should have red-tinted background"

        # Verify entity name has prominent font weight
        assert "font-weight: 700" in html or "font-weight: 600" in html, "Entity name should have bold font weight"
    ...
    def test_delete_modal_has_undo_warning(self):
        ...
        assert (
            "cannot be undone" in html.lower() or "permanent" in html.lower()
    ...
    def test_manage_view_has_delete_buttons(self):
        ...
        assert "delete-plan-btn" in html or "btn-delete" in html, "Delete buttons should exist in management view"
...
class TestDeleteConfirmationResponsive(BaseAPITestCase):
    ...
    def test_delete_modal_has_max_width(self):
        ...
        assert (
            "max-width: 540px" in html or "max-width: 500px" in html
