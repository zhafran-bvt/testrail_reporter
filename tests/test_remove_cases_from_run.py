...
class TestRemoveCasesFromRun:
    ...
    def test_remove_cases_from_run_success(self):
        ...
        resp = self.client.post(
            f"/api/manage/run/{run_id}/remove_cases",
            json={"case_ids": case_ids_to_remove}
        )
    ...
    def test_remove_cases_empty_case_ids(self):
        ...
        resp = self.client.post(
            "/api/manage/run/123/remove_cases",
            json={"case_ids": []}
        )
    ...
    def test_remove_cases_run_not_found(self):
        ...
        resp = self.client.post(
            "/api/manage/run/99999/remove_cases",
            json={"case_ids": [1, 2]}
        )
