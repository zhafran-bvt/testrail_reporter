...
class TestComprehensiveIntegration:
    ...
    def test_modular_architecture_integration(self):
        ...
        with patch('app.core.dependencies.get_plans_cache') as mock_cache, \
             patch('app.core.dependencies.get_testrail_client') as mock_client_dep:
    ...
    def test_error_handling_integration(self):
        ...
        response = client.post("/api/manage/plan", json={
            "project": -1,  # Invalid
            "name": "",     # Invalid
            "dry_run": False
        })
    ...
    def test_end_to_end_request_flow(self):
        ...
        with patch('app.core.dependencies.get_plans_cache') as mock_plans_cache, \
             ...
             patch('app.core.dependencies.get_testrail_client') as mock_client:
