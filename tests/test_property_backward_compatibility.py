...
class TestBackwardCompatibilityPreservation:
    ...
    def test_dashboard_api_response_format_compatibility(self):
        ...
        with patch('app.api.dashboard.testrail_service') as mock_service, \
             patch('app.core.dependencies.get_dashboard_plans_cache') as mock_cache:
    ...
    def test_plans_api_parameter_compatibility(self, project_id, plan_id):
        ...
        with patch('app.core.dependencies.get_plans_cache') as mock_cache, \
             patch('testrail_daily_report.env_or_die') as mock_env, \
             patch('testrail_client.get_plans_for_project') as mock_get_plans:
    ...
    def test_management_api_crud_compatibility(self):
        ...
        with patch('app.core.dependencies.get_testrail_client') as mock_get_client, \
             patch('app.core.dependencies.require_write_enabled') as mock_write:
    ...
    def test_health_check_endpoint_compatibility(self):
        ...
        # Mock dependencies
        with patch('app.core.dependencies.get_plans_cache') as mock_plans_cache, \
             patch('app.core.dependencies.get_runs_cache') as mock_runs_cache:
    ...
    def test_async_report_generation_compatibility(self):
        ...
        with patch('app.api.reports.job_manager') as mock_job_manager:
            ...
            mock_job_manager.serialize.return_value = {
                **mock_job.to_dict(),
                "queue_position": 0
            }
